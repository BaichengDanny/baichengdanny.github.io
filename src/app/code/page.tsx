...
export const metadata: Metadata = {
  title: "Code | Nicholas Carlini",
  description: "Research code and projects by Nicholas Carlini, including adversarial examples, security tools, and creative coding experiments.",
};
